<body id="body">
    <header id="header"class="lenguaje <?php echo isset($_GET['lang']) ? 'hidden' : ''; ?>">
        <a href="./index_EN.php" class="logo"><img src="./data/img/logo.png" alt="logo de la empresa" ></a>
        <nav>
            <ul class="url">
                <li><input type="text" id="busqueda" class="inputTitulo busqueda" placeholder="Search the article tittle"></li>
                <li><a class="optLink" href="./index_EN.php">Main Page</a></li>
                <li><a class="optLink" href="./aboutUs_EN.php">About Us</a></li>
                <li><a class="idiomas">
