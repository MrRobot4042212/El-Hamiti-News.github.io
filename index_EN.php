<header id="header"class="lenguaje <?php echo isset($_GET['lang']) ? 'hidden' : ''; ?>">
        ...
        <nav>
            <ul class="url">
            <li><input type="text" id="busqueda1" class="inputTitulo busqueda" placeholder="Busque el titulo de la noticia"></li>                <li><a class="optLink" href="./index.php">Main Page</a></li>
