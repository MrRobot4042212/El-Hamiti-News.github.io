...
<body id="body">
    <header id="header"class="header <?php echo isset($_GET['lang']) ? 'hidden' : ''; ?>">
        ...
        <nav>
            <ul class="url">
                <li><input type="text" id="busqueda1" class="inputTitulo busqueda" placeholder="Busque el título de la noticia"></li>
                <li><a class="optLink" href="./index.php">Página principal</a></li>
